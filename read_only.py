        ...
        while True:
            ...
            while True:
                ...
                if recnn_out is None:
                    for p in permutations(texts, 2):
                        port.send(''.join(p))
                    break
                
                # decode
                # TODO: problem zrozróżnianiem 5 i S, 2 i Z (rozważać zawsze 2 przypadki czy nowy rozpoznawacz?)
                texts.append(tr12.decode(recnn_out))
