...
class RRect:
    ...
    def _get_unrotated_corner_points(self) -> tuple[tuple[int,int]]:
...
class Rectangle:
    ...
    def get_dai_Rect(self) -> dai.Rect:
        return dai.Rect(self.x_min, self.y_min, self.x_max, self.y_max)

    def get_corner_points(self) -> tuple[tuple[int, int], tuple[int, int]]:
